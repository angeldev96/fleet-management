-- ============================================================================
-- MIGRATION: Add avg_speed_24h to vehicles_with_status view
-- Description: Adds average speed over last 24 hours for each vehicle
-- Date: 2026-02-02
-- ============================================================================
...
LEFT JOIN LATERAL (
    SELECT AVG(e.speed) AS avg_speed_24h
